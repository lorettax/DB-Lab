...
public class Transaction {
    ...
    public void commit() throws IOException, TransactionAbortedException, DbException {
        transactionComplete(false);
    }

    /** Finish the transaction */
    public void abort() throws IOException, TransactionAbortedException, DbException {
        transactionComplete(true);
    }

    /** Handle the details of transaction commit / abort */
    public void transactionComplete(boolean abort) throws IOException, TransactionAbortedException, DbException {
